...
// setHttpClient uses unsafe/reflect to set the unexported httpClient field in MetadatenClient.
func setHttpClient(client *inventur.MetadatenClient, hc *http.Client) {
...
func TestSearchOrders_ReturnsCombinedResults(t *testing.T) {
  ...
  <records>
	...
	setHttpClient(metaClient, &http.Client{Transport: mockTransport})
