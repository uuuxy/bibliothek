...
func bereinigeUndValidiereBuchEingabe(eingabe *BuchAnfrage) error {
...
func ergaenzeFehlendeMetadatenFuerAktualisierung(ctx context.Context, handler *APIHandler, eingabe *BuchAnfrage) {
