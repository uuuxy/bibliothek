			...
			setupMock: func(m pgxmock.PgxPoolIface) {
				...
				m.ExpectQuery("(?s)SELECT.*").
					...
					WillReturnRows(pgxmock.NewRows([]string{
						"id", "isbn", "title", "author", "signatur", "cover_url", "subject", "grade_level", "track", "ist_lernmittel", "verfuegbar", "gesamt", "last_counted", "sort_order", "medientyp", "jahrgang_von", "jahrgang_bis", "untertitel", "verlag", "erscheinungsjahr", "beschreibung", "erweiterte_eigenschaften", "auflage", "listenpreis", "ziel_jahrgang",
					}).AddRow(
						"b1", "123", "Book 1", "Author 1", "Sig 1", "url", "Math", int16(5), "G", false, int64(5), int64(10), &dateStr, 0, "Buch", 5, 10, "Sub", "Ver", 2020, "", map[string]any{}, "4. Aufl. 2023", nil, 0,
					))
			},
			expectedStatus: http.StatusOK,
			expectedBody:   `{"data":[{"id":"b1","isbn":"123","title":"Book 1","author":"Author 1","signatur":"Sig 1","coverUrl":"url","subject":"Math","gradeLevel":5,"track":"G","istLernmittel":false,"stock":10,"verfuegbar":5,"gesamt":10,"lastCounted":"2023-01-01","sortOrder":0,"medientyp":"Buch","jahrgangVon":5,"jahrgangBis":10,"zielJahrgang":0,"untertitel":"Sub","auflage":"4. Aufl. 2023","listenpreis":null,"verlag":"Ver","erscheinungsjahr":2020,"beschreibung":"","erweiterteEigenschaften":{}}]}`,
		},
		{
