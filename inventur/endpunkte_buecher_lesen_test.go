			...
			setupMock: func(m pgxmock.PgxPoolIface) {
				...
				m.ExpectQuery("(?s)SELECT.*").
					...
					WillReturnRows(pgxmock.NewRows([]string{
						...
						"b1", "123", "Book 1", "Author 1", "Sig 1", "url", "Math", int16(5), "G", false, int64(5), int64(10), &dateStr, 0, "Buch", 5, 10, "Sub", "Ver", 2020, "", map[string]any{}, "4. Aufl. 2023", nil,
					))
			},
			expectedStatus: http.StatusOK,
			expectedBody:   `{"data":[{"id":"b1","isbn":"123","title":"Book 1","author":"Author 1","signatur":"Sig 1","coverUrl":"url","subject":"Math","gradeLevel":5,"track":"G","istLernmittel":false,"stock":10,"verfuegbar":5,"gesamt":10,"lastCounted":"2023-01-01","sortOrder":0,"medientyp":"Buch","jahrgangVon":5,"jahrgangBis":10,"untertitel":"Sub","auflage":"4. Aufl. 2023","listenpreis":null,"verlag":"Ver","erscheinungsjahr":2020,"beschreibung":"","erweiterteEigenschaften":{}}]}`,
		},
		{
