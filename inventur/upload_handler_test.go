...
func TestSaveCoverFile(t *testing.T) {
	...
	// Create symbolic link to redirect "uploads" to our temp dir
	// In Go, since saveCoverFile hardcodes "uploads", we'll just run it in the temp dir
