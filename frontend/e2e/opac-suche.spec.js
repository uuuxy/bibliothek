...
test('OPAC: öffentliche Suche ohne Login zeigt Verfügbarkeit, leakt keine Personendaten', async ({ page }) => {
    ...
    const res = await page.request.get(`/api/public/opac/suche?q=${encodeURIComponent(`E2E Opactitel ${s}`)}`);
