...
>
    ...
    {:else}
        <BuchKarteCover subject={book.subject} title={book.title} author={book.author} medientyp={book.medientyp} isbn={book.isbn} />
    {/if}
    ...
    <div class="grow p-5 pt-4 flex flex-col justify-between">
            ...
            >
                ...
                {#if book.isbn}
                    {#if copied}
                        ...
                        >
                    {:else}
                        <svg class="w-3.5 h-3.5 text-slate-300 opacity-0 group-hover/isbn:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
                    {/if}
                {/if}
            </button>
        ...
        <div class="space-y-4">
            ...
            >
                <svg class="w-3.5 h-3.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                <span>
