...
const ICONS = {
	...
	Search: (size = 24, strokeW = 2, className = '') =>
		'<svg xmlns="http://www.w3.org/2000/svg" width="' +
		size +
		'" height="' +
		size +
	...
	Check: (size = 24, strokeW = 2, className = '') =>
		'<svg xmlns="http://www.w3.org/2000/svg" width="' +
		size +
		'" height="' +
		size +
	...
	Save: (size = 24, strokeW = 2, className = '') =>
		'<svg xmlns="http://www.w3.org/2000/svg" width="' +
		size +
		'" height="' +
		size +
...
[
	'ClassAssignmentDialog.svelte',
	'ClassAssignmentSelector.svelte',
	'ClassAssignmentBookGrid.svelte',
	'ClassAssignmentSummary.svelte'
].forEach(processFile);
