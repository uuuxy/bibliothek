...
<div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 pb-2 mt-6 sm:mt-8">
    {#each filteredBooks as book (book.id)}
        ...
        >
            ...
            <!-- Cover -->
            <div
                class="aspect-2/3 w-full overflow-hidden bg-surface-container relative shrink-0"
            >
                {#if book.coverUrl}
                    <img
                        src={book.coverUrl}
