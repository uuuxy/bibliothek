...
{#each filteredClasses as cls (cls.name)}
	<section class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 mb-6">
		...
		<div
			class="relative group/carousel carousel-wrapper"
		...
		>
			...
			<div
				use:scrollHandler
				class="carousel-container flex overflow-x-auto gap-4 pb-4 pt-2 px-2 snap-x snap-mandatory hide-scrollbar scroll-smooth"
			>
