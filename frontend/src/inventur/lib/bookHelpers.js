...
export function getSubjectGradient(subject) {
    ...
    if (clean.includes("math")) return "bg-linear-to-br from-blue-600 via-indigo-600 to-blue-700 border-blue-500/30";
    if (clean.includes("deu")) return "bg-linear-to-br from-red-600 via-rose-600 to-red-700 border-red-500/30";
    if (clean.includes("eng") || clean.includes("fra") || clean.includes("spa") || clean.includes("lat") || clean.includes("spr")) return "bg-linear-to-br from-violet-600 via-purple-600 to-violet-700 border-purple-500/30";
    if (clean.includes("bio") || clean.includes("che") || clean.includes("phy") || clean.includes("nat")) return "bg-linear-to-br from-teal-600 via-emerald-600 to-teal-700 border-teal-500/30";
    if (clean.includes("ges") || clean.includes("pol") || clean.includes("geo") || clean.includes("erd") || clean.includes("soz")) return "bg-linear-to-br from-amber-600 via-orange-600 to-amber-700 border-amber-500/30";
    if (clean.includes("mus") || clean.includes("kun")) return "bg-linear-to-br from-pink-600 via-fuchsia-600 to-pink-700 border-pink-500/30";
    if (clean.includes("inf")) return "bg-linear-to-br from-slate-600 via-slate-700 to-slate-800 border-emerald-500/30";
