...
>
	<div class="flex items-center space-x-3">
		<div
			class="w-10 h-10 rounded-full flex items-center justify-center font-bold {selected
		...
		<div>
			<div class="font-bold {selected ? 'text-white' : 'text-slate-900'}">
				{student.vorname}
				{student.nachname}
			</div>
			<div class="text-xs {selected ? 'text-blue-100' : 'text-slate-500'}">
				{student.klasse}
