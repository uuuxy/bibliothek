...
<div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-start overflow-y-auto">
	<div class="space-y-4">
		<h2 class="text-base font-bold text-slate-800 border-b border-gray-200 pb-3">
			Neuer Lieferant
		</h2>
		<form onsubmit={handleSubmit} class="space-y-4 text-base">
			<div class="space-y-1.5">
				<label for="n" class="block font-medium text-gray-600 text-sm">Name</label><input
					id="n"
					type="text"
					bind:value={newName}
					required
			...
			<div class="space-y-1.5">
				<label for="e" class="block font-medium text-gray-600 text-sm">E-Mail</label><input
					id="e"
					type="email"
					bind:value={newEmail}
					required
			...
			<div class="space-y-1.5">
				<label for="c" class="block font-medium text-gray-600 text-sm">Kundennummer</label><input
					id="c"
					type="text"
