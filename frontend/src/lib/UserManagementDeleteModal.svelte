  ...
  {#snippet children()}
    <div class="p-6 space-y-4">
      ...
      <div class="flex items-center justify-center gap-3 pt-3 border-t border-slate-100">
        <button onclick={onclose} disabled={deletingUser} class="px-4 py-2 text-xs font-semibold border border-slate-200 rounded-xl hover:bg-slate-50 cursor-pointer">Abbrechen</button>
