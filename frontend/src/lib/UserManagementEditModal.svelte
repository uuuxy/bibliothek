  ...
  {#snippet children()}
    <form onsubmit={handleSaveUser} class="p-6 space-y-4">
      ...
      <div class="flex items-center justify-end gap-3 pt-3 border-t border-slate-100">
        <button type="button" onclick={onclose} class="px-4 py-2 text-xs font-semibold border border-slate-200 rounded-xl hover:bg-slate-50 cursor-pointer">Abbrechen</button>
