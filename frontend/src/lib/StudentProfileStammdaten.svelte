<script>
	...
	import LeserPersoenlicheDaten from './components/students/LeserPersoenlicheDaten.svelte';
...
<!-- Kollegium bekommt einen eigenen Abschnitt: Geburtsdatum, LUSD-Kennung, Postanschrift
     und Elternadresse gehören einem Kollegen nicht, und als „Keine Angabe" behauptete die
     Akte, sie fehlten. Zusammenführen ist ebenfalls eine Schülersache (LUSD-Dubletten). -->
{#if istKollegium(profile)}
	<LeserPersoenlicheDaten {profile} />
{:else}
