...
export function useBookAkte() {
    ...
    return {
        ...
        get borrowers() { return borrowers; },
        get exemplare() { return exemplare; },
        set exemplare(v) { exemplare = v; },
        ...
        get coverSrc() { return coverCandidates[currentCandidateIndex] || ""; },
        get coverFailed() { return coverFailed; },
        loadAll,
        deleteTitle,
        editTitle,
        onCoverError,
