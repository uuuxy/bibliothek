...
type StudentRepository interface {
	...
	ListStudentsWithStats(ctx context.Context, klassen []string, suche string, sortierung SchuelerSortierung) ([]StudentListStat, error)
	...
	ListLeserMitStats(ctx context.Context, klassen []string, suche string, sortierung SchuelerSortierung) ([]StudentListStat, error)
	...
	ListEhemaligeWithStats(ctx context.Context, suche string, sortierung SchuelerSortierung) ([]StudentListStat, error)
}
