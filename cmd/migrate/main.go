...
// each with a unique sequential B-[number] barcode.
//
...
// highestBarcodeSeq reads the current highest B-[number] sequence number from PostgreSQL.
...
// validateBarcode ensures a barcode matches the expected B-[number] pattern.
