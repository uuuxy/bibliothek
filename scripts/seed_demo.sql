...
SELECT
    'DEMO-S-' || i,
    p.vn[1 + (i % array_length(p.vn, 1))],
    p.nn[1 + ((i / 7) % array_length(p.nn, 1))],
...
CROSS JOIN (SELECT
    ARRAY['Lukas','Leon','Finn','Noah','Elias','Paul','Ben','Jonas','Emma','Mia','Hannah','Emilia','Sofia','Lina','Marie','Lena','Yusuf','Ali','Aylin','Mert','Sophie','Charlotte','Maximilian','Felix'] AS vn,
    ARRAY['Müller','Schmidt','Schneider','Fischer','Weber','Meyer','Wagner','Becker','Schulz','Hoffmann','Koch','Bauer','Richter','Klein','Wolf','Yılmaz','Kaya','Demir','Nguyen','Popović','Schäfer','Braun','Krüger','Hofmann'] AS nn,
