...
| Geschwister-Asymmetrie        | zwei gleichartige Pfade, einer kann etwas, der andere nicht (Anliegen-Notiz vs. Klassensatz)       | —                                                        | **kein Gate** — Kandidaten: alle Paare „Lehrkraft löst aus → Theke schließt ab → Mail"             |
| Verschluckte Ursache          | Fehler wird in eine generische Antwort gebogen, ohne Logzeile (Selbstanmeldung-401, CI 29.08.)     | —                                                        | Teilklasse des Kollaps; b8daed0a loggt den einen Fall                                              |
