...
Stand: 03.09.2026 (erhoben 19.08.2026, alle 6 Abschnitte Handler für Handler und
...
| `GET /api/portal/lernmittel/export` | Sitzung | 0 | Dieselben Daten als PDF-Bestandsliste (Titel, Autor, ISBN, Jahrgang, Schulzweig, Zähldatum, Zahlen, Coverbild aus dem lokalen Upload-Verzeichnis) |
