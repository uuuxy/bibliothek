...
> Generiert von `scripts/api_inventar.sh` am 2026-09-17. Nicht von Hand editieren.
...
- `GET /api/bestand/abgangsbuch`
- `GET /api/bestand/abgangsbuch/pdf`
- `GET /api/bestand/zugangsbuch`
- `GET /api/bestand/zugangsbuch/pdf`
