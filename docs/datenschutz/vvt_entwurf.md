...
| **Löschfristen** | Ausleihvorgang bleibt der Person **730 Tage nach Rückgabe** zugeordnet (Bestandskartei, Schadensersatz über das Folgeschuljahr), danach automatisch getrennt (nächtlicher Job; Frist einstellbar). Bearbeitende Person der Ausleihe nach 14 Tagen entfernt. Schülerdatensatz: beim Abgang (nicht mehr in der LUSD) ab 30. Januar des Folgejahres gelöscht, sofern keine offene Ausleihe / kein unbezahlter Schadensfall; Abgänger ohne offene Vorgänge nach der Karenzzeit (einstellbar, Vorgabe 90 Tage ab Abgang; bis 02.09.2026: 360 Tage) anonymisiert (Name, Adresse, Geburtsdatum, Schuleintritt, LUSD-ID, Eltern-E-Mail, Foto; Spuren in Audit und Vormerkungen getilgt). Protokolle 24 Monate. Verschlüsselte Backups 14 Tage. |
| **TOM** | siehe Anhang. |
...
| Datenminimierung/Löschung | Automatische Jobs: Bearbeiter-ID 14 Tage, Lesehistorie 90/730 Tage, Abgänger-Löschung, Anonymisierung 180 Tage (Papierkorb) / Karenzzeit 90 Tage (Abgänger, einstellbar), Audit 24 Monate. Betroffenenauskunft (Art. 15) als JSON/PDF für Admins. |
