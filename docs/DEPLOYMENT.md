...
| `IMAP_PORT`                                                                | IMAP-Port                                                                                                                                                                                                                                    | Standard: 993. Wirkt im Docker-Betrieb nicht, solange `docker-compose.yml` sie nicht durchreicht (offener Betriebsposten #599)                                                                                                             |
...
| `ALLOWED_ORIGIN`                                                           | Erlaubte Herkunft für CORS (die Frontend-Adresse der Schule)                                                                                                                                                                                 | Empfohlen in Produktion. Wirkt im Docker-Betrieb nicht, solange `docker-compose.yml` sie nicht durchreicht (offener Betriebsposten #599)                                                                                                   |
...
| `SMTP_ALLOW_INSECURE_TLS`                                                  | TLS-Zertifikatsprüfung deaktivieren (TLS bleibt)                                                                                                                                                                                             | Nur für Legacy-SMTP-Server. Wirkt im Docker-Betrieb nicht, solange `docker-compose.yml` sie nicht durchreicht (offener Betriebsposten #599)                                                                                                |
| `SMTP_ALLOW_PLAINTEXT`                                                     | Versand **ganz ohne** TLS erlauben, wenn der Server kein STARTTLS anbietet                                                                                                                                                                   | Nur für ein Legacy-Relay. Ohne diese Variable bricht der Versand in dem Fall ab, statt Mahntexte im Klartext zu schicken. Wirkt im Docker-Betrieb nicht, solange `docker-compose.yml` sie nicht durchreicht (offener Betriebsposten #599)  |
...
| `RATE_LIMIT`                                                               | Globales Limit in Requests/s/IP                                                                                                                                                                                                              | Vorgabe **50** (der Produktionswert). Ein unlesbarer Wert wird protokolliert und ignoriert, es gilt dann die Vorgabe. Wirkt im Docker-Betrieb nicht, solange `docker-compose.yml` sie nicht durchreicht (offener Betriebsposten #599)      |
...
| `SENTRY_DSN`                                                               | Sentry Error Tracking                                                                                                                                                                                                                        | Optional. Wirkt im Docker-Betrieb nicht, solange `docker-compose.yml` sie nicht durchreicht (offener Betriebsposten #599)                                                                                                                  |
