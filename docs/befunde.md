...
| ---------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Versetzung + LUSD unter Einstellungen → Datenverwaltung          | Reiter **„Schuljahreswechsel"** in der Schülerdatei (sichtbar mit `import_students` oder `manage_students_admin`). Datenverwaltung behält Import/Export/Offline-Sicherungen. |
...
| Kein Weg zum Klassensatz-Ausweisdruck                            | War am selben Tag schon erledigt: `KlassenDruckEinstieg` im Druck-Center-Reiter „Schülerausweise" springt mit markierter Klasse in die Schülerdatei.                         |
