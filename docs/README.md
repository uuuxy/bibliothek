...
Dieses Dokument beschreibt lückenlos und sachlich die funktionale Business-Logik der Bibliothekssoftware auf Basis der tatsächlichen Go-Implementierung. Es richtet sich an Administratoren, Betreiber und Entwickler, um ein exaktes Verständnis der Systemprozesse zu gewährleisten.
