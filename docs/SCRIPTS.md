...
| `tabula_rasa.sql`                 | Bereinigt die Datenbank für den Echtbetrieb (Bewegungsdaten raus).                                                                                                                                                                                                                                                                                                    | **Löscht Daten.** Vorher Backup. **Bricht seit Migration 124 ab** (`schueler` ist eine Sicht) und ändert dann nichts; seine Tabellenliste kennt weder `leser` noch `werke`. Ob es noch gebraucht wird: OFFEN.md 5.27. |
| `repair_titel_dubletten.sql`      | Einmalige Reparatur (13.07.2026): räumt Titel-Dubletten aus dem Import auf.                                                                                                                                                                                                                                                                                           | **Nicht wieder laufen lassen:** Es gruppiert allein über den Titel und legt damit auch Auflagen desselben Schulbuchs mit verschiedener ISBN zu einem Titel zusammen — seit Migration 148 bleibt jede Auflage ein eigener Titel. Was aus dem Skript wird: OFFEN.md 5.26. |
