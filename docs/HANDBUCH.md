...
| `https://<schule>/monitor` | der Bildschirm vor der Bibliothek | Endlos-Slideshow: Buch des Monats (meistausgeliehen in 30 Tagen), Neu eingetroffen, Beliebt diese Woche. Nur Titel mit Cover. |
