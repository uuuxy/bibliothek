...
| Eine Bestellung = **ein Topf** (`land` / `schultraeger`); neue Bestellungen tragen ihn immer, Alt-Bestellungen nur wo eindeutig | 🟢 CHECK + Go-Guard (400) + PG-Test                        | `bestellungen_verlauf_mittel_check`, `api/order_service.go`, `api/bestellung_mittel_pg_test.go` |
