...
| Jede Bewegung eines Exemplars (Ausleihe, Rückgabe, Rückholen, Aussonderung) setzt `letzte_bewegung_am`; jede Ausleihe trägt `erfasst_am` (Scan-Zeitpunkt, höchstens Serverzeit)                                                                                | 🟡 von den Schreibern gesetzt, nicht vom Trigger; PG-Test je Bewegung                     | `migrations/116_bewegungsstempel.sql`, `repository/bewegungsstempel_pg_test.go`  |
