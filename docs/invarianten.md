...
| Barcode eindeutig **unter aktiven** (Soft-Delete gibt ihn zum Recycling frei). **Nullbar seit Migration 123**: Ein Kollege hat erst eine Nummer, wenn eine vergeben ist — die Pflicht gilt gepaart an der Art | 🟢 partieller Unique-Index + `chk_leser_schueler_pflichtfelder` | `leser.barcode_id`, `uniq_schueler_barcode_active` |
