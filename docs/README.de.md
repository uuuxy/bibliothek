...
> **Hinweis:** Dies ist die deutsche Dokumentation. For the English version, see [README.md](README.md).

| Dokument | Inhalt |
|---|---|
| [ARCHITECTURE.de.md](ARCHITECTURE.de.md) | Schichtenarchitektur, Concurrency-Modell, Datenbankdesign, Frontend |
| [SECURITY.de.md](SECURITY.de.md) | Sicherheitskonzept, DSGVO, Schutzmaßnahmen |
| [DEPLOYMENT.de.md](DEPLOYMENT.de.md) | Produktions-Deployment, Umgebungsvariablen, Caddy, Backups |
| [INSTALL.de.md](INSTALL.de.md) | Lokales Setup |
| [SCRIPTS.de.md](SCRIPTS.de.md) | CLI-Werkzeuge und Migrationen |
| [CHANGELOG.de.md](CHANGELOG.de.md) | Änderungshistorie |
| [resilience_and_recovery.de.md](resilience_and_recovery.de.md) | Backup-Verschlüsselung, Restore-Probe, Notfall-Wiederherstellung |
| [backup_cron.de.md](backup_cron.de.md) | Backup-Cronjob-Einrichtung |
| [master_fahrplan.de.md](master_fahrplan.de.md) | Status-Dokument: erledigt / offen / Parkdeck |
| [api_inventar.de.md](api_inventar.de.md) | Generiertes Routen-Inventar (`scripts/api_inventar.sh`) |
...
Details: [ARCHITECTURE.de.md](ARCHITECTURE.de.md)
