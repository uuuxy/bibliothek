...
| 12  | **LUSD & Versetzung**       | LUSD-Abgleich (§8) und Klassen-Versetzung zum Schuljahresende; hieß bis 06.09.2026 „Schuljahreswechsel" — derselbe Name wie der LMF-Plan im System-Menü, deshalb umbenannt (Rechte: import_students bzw. manage_students_admin)                                                                                                                                                                                                                                                                                                                                                                                                     | `import_students` / `manage_students_admin` |
